...
/* This class object is tasked with taking in a newly created
 * Patient ID then displaying this new ID number ONCE to the new Patient account.
 * The Patient ID is generated after the Patient completes the Portal_RegistrationPortal.
 * It is up to the Patient to remember the unique and personal ID number as it will
 * not be displayed to them again */
class PatientID_Display {
	public PatientID_Display() {}
	
	public void showID(int num) {
		Alert alert = new Alert(AlertType.INFORMATION);
		alert.setTitle("Information");
		alert.setHeaderText(null);
		alert.setContentText("This is your unique Patient ID: " + num + "\n" + "You will not be shown this again. Remember it or Save it");
		alert.showAndWait();
	}
}